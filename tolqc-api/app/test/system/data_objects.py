...
TEST_DATA = [
    ...
    LibraryType(
        library_type_id='Hi-C', hierarchy_name='hic', category='genomic_data'
    ),
    LibraryType(
    ...
    VisibilityDict(
        visibility='Always', description='Shown in standard reporting'
    ),
    VisibilityDict(
        visibility='Testing', description='Sequencing development data'
    ),
    VisibilityDict(
        visibility='Withdrawn', description='Data has been deleted'
    ),
    Project(
        project_id=17,
                            ...
                            Data(
                                ...
                                files=[
                                    File(
                                        ...
                                        data_id=115631,
                                        remote_path=(
                                            '/seq/illumina/runs/37/37939'
                                            '/lane1/plex2/37939_1#2.cram'
                                        ),
                                    )
                                ],
                                project_assn=[
                            ...
                            Data(
                                ...
                                files=[
                                    File(
                                        ...
                                        data_id=117960,
                                        remote_path=(
                                            '/seq/illumina/runs/35/35528'
                                            '/lane4/plex8/35528_4#8.cram'
                                        ),
                                    )
                                ],
                                project_assn=[
                            ...
                            Data(
                                ...
                                files=[
                                    File(
                                        ...
                                        data_id=118427,
                                        remote_path=(
                                            '/seq/illumina/runs/36/36691'
                                            '/lane2/plex5/36691_2#5.cram'
                                        ),
                                    )
                                ],
                                project_assn=[
                            ...
                            Data(
                                ...
                                files=[
                                    File(
                                        ...
                                        data_id=121083,
                                        remote_path=(
                                            '/seq/illumina/runs/40/40666'
                                            '/lane2/plex2/40666_2#2.cram'
                                        ),
                                    )
                                ],
                                project_assn=[
